...
exports.InterAgentCompressor = void 0;
/**
 ...
 */
function simpleSummarize(text, maxLength) {
...
class InterAgentCompressor {
    ...
    compress(messages) {
        ...
        const compressedTokens = compressed.reduce((sum, msg) => sum + this.estimateTokens(msg.content ?? ""), 0);
        return {
            messages: compressed,
            originalTokens,
            compressedTokens,
...
exports.InterAgentCompressor = InterAgentCompressor;
exports.default = InterAgentCompressor;
//# sourceMappingURL=interAgentCompression.js.map