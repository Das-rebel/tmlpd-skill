...
exports.FetchOnceProcessor = void 0;
/**
 ...
 */
async function extractWithCheapModel(content, task, cheapModel) {
...
class FetchOnceProcessor {
     ...
     */
    async process(url, task, options = {}) {
    ...
    async processBatch(urls, task, options = {}) {
        return Promise.all(urls.map(url => this.process(url, task, options)));
    }
    /**
...
exports.FetchOnceProcessor = FetchOnceProcessor;
exports.default = FetchOnceProcessor;
//# sourceMappingURL=fetchOnceLocal.js.map