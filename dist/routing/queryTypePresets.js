...
exports.getPresetForQuery = getPresetForQuery;
// ============================================================
// DEFAULT PRESETS
// ============================================================
...
// PRESET ROUTER
// ============================================================
function createPresetRouter(customPresets) {
    const presets = { ...exports.DEFAULT_PRESETS, ...customPresets };
    return {
        presets,
        defaultPreset: 'fast',
        classify(query) {
